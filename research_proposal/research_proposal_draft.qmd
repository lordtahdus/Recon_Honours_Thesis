...
The choice of $\boldsymbol{G}$ determines the composition of reconciled forecasts $\tilde{\boldsymbol{y}}_h$. Methods are developed to estimate $\boldsymbol{G}$, including the OLS and WLS, proposed by @Hyndman2011-jv and @Hyndman2016-ic respectively.

- expand on about OLS and WLS
