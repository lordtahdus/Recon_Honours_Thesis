...
The proposed MinT approach by @Wickramasuriya2019-xq uses the shrinkage estimator from @Schafer2005-yw. \textcolor{red}{It guarantees positive definiteness and huge variance reduction when $p>T$}. The shrinkage estimator is given by:
