---
title: "Draft - Enhancing Forecast Reconciliation: A Study of Covariance Estimation"
author: "Vincent Su"
date: "`r Sys.Date()`"
output: 
  pdf_document
...
$$ 
where $\bm{S}$ is a summing matrix of order $m x n$ which aggregates the bottom-level series $\bm{b}_t$ ($n$-vector) to the series at aggregation levels above. The $m$-vector $\bm{y}_t$ contains all observations at time $t$
