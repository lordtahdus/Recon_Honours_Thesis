...
\color{red}
This points to tail-calibration sensitivity at high nominal coverage. The reconciliation that helps central accuracy can degrade extreme-tail interval performance when uncertainty is misallocated across the hierarchy.
\color{black}
