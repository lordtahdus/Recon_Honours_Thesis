...
# sim1_1 <- readRDS("./lib/S4-2-1_T100_M10000_par.rds")
# sim1_2 <- readRDS("./lib/S4-2-1_T300_M10000.rds")
# 
sim2_1 <- readRDS("./lib/S36-6-1_T100_M100_run1.rds")
sim2_2 <- readRDS("./lib/S36-6-1_T300_M100_run2.rds")

# sim3_1 <- readRDS("./lib/S100-2-1_T50_M200_run1.rds")
# sim3_2 <- readRDS("./lib/S100-2-1_T100_M200_run1.rds")
```
...
- Finding: Larger size MinT_n performs well
