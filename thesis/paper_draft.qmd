...
<!-- Write cover page my own -->

::: {=latex}
\begin{titlepage}

\begin{center}
\includegraphics[height=2cm,keepaspectratio]{D:/Github/Recon_Honours_Thesis/assets/monash-logo.png}
\end{center}
...
```{r load results}
path_lib <- paste0(path, "/thesis/lib/")
...
tourism_coverage95 <- readRDS(paste0(path, "/thesis/lib/tourism_coverage95.rds"))
tourism_W95_level <- readRDS(paste0(path, "/thesis/lib/tourism_W95_level.rds"))
