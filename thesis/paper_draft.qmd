...
sim1_1 <- readRDS(paste0(path_lib, "S4-2-1_T50_M500.rds"))
sim1_2 <- readRDS(paste0(path_lib, "S4-2-1_T300_M500.rds"))

sim2_1 <- readRDS(paste0(path_lib, "S36-6-1_T50_M500.rds"))
sim2_2 <- readRDS(paste0(path_lib, "S36-6-1_T300_M500.rds"))

sim_dense_50 <- readRDS(paste0(path_lib, "S100-10-3-1_T50_M200_dense.rds"))
sim_dense_300 <- readRDS(paste0(path_lib, "S100-10-3-1_T300_M200_dense.rds"))

sim_sparse_50 <- readRDS(paste0(path_lib, "S100-10-3-1_T50_M500_sparsebwgrp.rds"))
sim_sparse_300 <- readRDS(paste0(path_lib, "S100-10-3-1_T300_M200_sparsebwgrp.rds"))
